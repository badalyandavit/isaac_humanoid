...
| Field | Value |
|---|---|
| `baseline_name` | isaac_v2_mild_upright_controlled_humanoid_direct |
| `simulator_backend` | Isaac Lab |
| `task` | Isaac-Humanoid-Direct-v0 |
| `reward_version` | isaac_v2_mild_upright_controlled |
...
| `simulator.termination_height` | 0.85 |
| `reward.design_goal` | Encourage cleaner upright forward locomotion without the harsh early termination and penalties used in V1. |
| `reward.progress_reward` | change in negative distance-to-target potential |
| `reward.alive_reward_scale` | 1.5 |
| `reward.heading_weight` | 0.75 |
| `reward.heading_full_reward_threshold` | 0.8 |
| `reward.up_weight` | 0.25 |
| `reward.up_reward_threshold` | 0.93 |
| `reward.actions_cost_scale` | 0.015 |
| `reward.energy_cost_scale` | 0.06 |
| `reward.dof_vel_scale` | 0.1 |
| `reward.dof_at_limit_cost` | subtract count of joints with scaled position > 0.98 |
| `reward.death_cost` | -2.0 |
...
| `reward.configured_parameters.heading_weight` | 0.75 |
| `reward.configured_parameters.up_weight` | 0.25 |
| `reward.configured_parameters.energy_cost_scale` | 0.06 |
| `reward.configured_parameters.actions_cost_scale` | 0.015 |
| `reward.configured_parameters.alive_reward_scale` | 1.5 |
| `reward.configured_parameters.dof_vel_scale` | 0.1 |
| `reward.configured_parameters.death_cost` | -2.0 |
| `reward.configured_parameters.termination_height` | 0.85 |
...
| `reward.parameter_changes_from_v0.heading_weight.configured` | 0.75 |
| `reward.parameter_changes_from_v0.up_weight.official_v0` | 0.1 |
| `reward.parameter_changes_from_v0.up_weight.configured` | 0.25 |
| `reward.parameter_changes_from_v0.energy_cost_scale.official_v0` | 0.05 |
| `reward.parameter_changes_from_v0.energy_cost_scale.configured` | 0.06 |
| `reward.parameter_changes_from_v0.actions_cost_scale.official_v0` | 0.01 |
| `reward.parameter_changes_from_v0.actions_cost_scale.configured` | 0.015 |
| `reward.parameter_changes_from_v0.alive_reward_scale.official_v0` | 2.0 |
| `reward.parameter_changes_from_v0.alive_reward_scale.configured` | 1.5 |
| `reward.parameter_changes_from_v0.death_cost.official_v0` | -1.0 |
| `reward.parameter_changes_from_v0.death_cost.configured` | -2.0 |
| `reward.parameter_changes_from_v0.termination_height.official_v0` | 0.8 |
| `reward.parameter_changes_from_v0.termination_height.configured` | 0.85 |
| `reward.auto_hydra_overrides` | ['env.heading_weight=0.75', 'env.up_weight=0.25', 'env.energy_cost_scale=0.06', 'env.actions_cost_scale=0.015', 'env.alive_reward_scale=1.5', 'env.death_cost=-2.0', 'env.termination_height=0.85'] |
| `reward.notes` | ['V2 keeps Isaac Lab physics unchanged and changes reward coefficients only.', 'V2 is intentionally softer than V1 because V1 over-penalized early falling before balance was learned.', 'Heading and upright terms are stronger than V0 but not dominant.', 'Alive reward remains meaningful so the policy has a survival curriculum while learning locomotion.', 'Termination height and death cost are only mildly stricter than V0.'] |
