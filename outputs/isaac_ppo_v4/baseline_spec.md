...
| Field | Value |
|---|---|
| `baseline_name` | isaac_v4_morphology_reward_humanoid_direct |
| `simulator_backend` | Isaac Lab |
| `task` | Isaac-Humanoid-V4-Direct-v0 |
| `reward_version` | isaac_v4_morphology_reward |
...
| `simulator.termination_height` | 1.05 |
| `reward.design_goal` | Add explicit morphology and gait-quality penalties to prevent the low spider/crawling reward exploit observed in V2/V3. |
| `reward.custom_isaac_task` | True |
| `reward.progress_reward` | change in negative distance-to-target potential |
| `reward.alive_reward_scale` | 0.8 |
| `reward.heading_weight` | 1.0 |
| `reward.heading_full_reward_threshold` | 0.8 |
| `reward.up_weight` | 1.0 |
...
| `reward.configured_parameters.up_weight` | 1.0 |
| `reward.configured_parameters.energy_cost_scale` | 0.08 |
| `reward.configured_parameters.actions_cost_scale` | 0.02 |
| `reward.configured_parameters.alive_reward_scale` | 0.8 |
| `reward.configured_parameters.dof_vel_scale` | 0.1 |
| `reward.configured_parameters.death_cost` | -6.0 |
| `reward.configured_parameters.termination_height` | 1.05 |
| `reward.configured_parameters.angular_velocity_scale` | 0.25 |
| `reward.configured_parameters.contact_force_scale` | 0.01 |
| `reward.custom_v4_parameters.height_target` | 1.35 |
| `reward.custom_v4_parameters.height_bonus_scale` | 4.0 |
| `reward.custom_v4_parameters.low_height_threshold` | 1.15 |
| `reward.custom_v4_parameters.low_height_penalty_scale` | 6.0 |
| `reward.custom_v4_parameters.torso_low_height` | 1.1 |
| `reward.custom_v4_parameters.torso_low_penalty_scale` | 4.0 |
| `reward.custom_v4_parameters.arm_low_height` | 0.65 |
| `reward.custom_v4_parameters.arm_low_penalty_scale` | 4.0 |
| `reward.custom_v4_parameters.leg_pose_penalty_scale` | 0.6 |
| `reward.custom_v4_parameters.arm_pose_penalty_scale` | 0.8 |
| `reward.custom_v4_parameters.action_rate_penalty_scale` | 0.04 |
...
| `reward.parameter_changes_from_v0.up_weight.configured` | 1.0 |
...
| `reward.parameter_changes_from_v0.alive_reward_scale.configured` | 0.8 |
| `reward.parameter_changes_from_v0.death_cost.official_v0` | -1.0 |
| `reward.parameter_changes_from_v0.death_cost.configured` | -6.0 |
| `reward.parameter_changes_from_v0.termination_height.official_v0` | 0.8 |
| `reward.parameter_changes_from_v0.termination_height.configured` | 1.05 |
| `reward.auto_hydra_overrides` | ['env.heading_weight=1.0', 'env.up_weight=1.0', 'env.energy_cost_scale=0.08', 'env.actions_cost_scale=0.02', 'env.alive_reward_scale=0.8', 'env.death_cost=-6.0', 'env.termination_height=1.05', 'env.height_target=1.35', 'env.height_bonus_scale=4.0', 'env.low_height_threshold=1.15', 'env.low_height_penalty_scale=6.0', 'env.torso_low_height=1.1', 'env.torso_low_penalty_scale=4.0', 'env.arm_low_height=0.65', 'env.arm_low_penalty_scale=4.0', 'env.leg_pose_penalty_scale=0.6', 'env.arm_pose_penalty_scale=0.8', 'env.action_rate_penalty_scale=0.04'] |
| `reward.custom_v4_reward_terms` | ['height bonus for maintaining torso/root height near target', 'low torso/root height penalty', 'low torso/pelvis/head body penalty', 'low arm/hand body penalty as a proxy for arm-supported crawling', 'leg joint pose penalty to discourage deep crouch', 'arm joint pose penalty to discourage arm-driven locomotion', 'action-rate penalty for smoother motion'] |
| `reward.notes` | ['V4 installs a custom Isaac Lab direct humanoid task instead of changing only built-in reward coefficients.', 'The custom reward adds root-height, torso-height, arm-height, leg-posture, arm-posture, and action-rate terms.', 'Arm/hand low-height penalties are a proxy for discouraging arm-supported crawling.', 'V4 may score lower than V2/V3; qualitative gait quality is the main criterion.'] |
